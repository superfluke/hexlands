...
public class Layout
{
    ...
    static public Orientation pointy = new Orientation(Hex.sqr3, Hex.sqr3o2, 0.0, 3.0 / 2.0, Hex.sqr3 / 3.0, -1.0 / 3.0, 0.0, 2.0 / 3.0, 0.5);
    static public Orientation flat = new Orientation(3.0 / 2.0, 0.0, Hex.sqr3o2, Hex.sqr3, 2.0 / 3.0, 0.0, -1.0 / 3.0, Hex.sqr3 / 3.0, 0.0);
