...
public class HexGenRavine extends MapGenBase
{
...
//        if (state.getBlock() == ChunkGeneratorOverworldHex.RIM)
//        	return true;
//        else
    ...
    protected void digBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ, boolean foundTop)
    {
        ...
        //dafuq doesnt this work
        //if(state.getBlock() == ChunkGeneratorOverworldHex.RIM)
//        if(state.getBlock() == Blocks.STONEBRICK.getDefaultState())
//        {
//        	System.out.printf("stonebrick at x: %d, z:%d\n", x + chunkX * 16, z + chunkZ * 16);
//        }

        if (state.getBlock() == Blocks.STONE || state.getBlock() == top.getBlock() || state.getBlock() == filler.getBlock())// || state.getBlock() == ChunkGeneratorOverworldHex.RIM)
        {
        	//System.out.printf("rave at x: %d, z:%d\n", x + chunkX * 16, z + chunkZ * 16);
            if (y - 1 < 10)
            {
